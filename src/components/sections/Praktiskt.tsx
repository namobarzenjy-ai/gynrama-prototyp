      ...
      <div className="mx-auto max-w-[1240px] px-6 py-24 lg:py-28">
        ...
        <div className="mt-14 grid gap-6 rounded-card bg-slate-deep p-8 text-white sm:grid-cols-3 lg:p-10">
          <div>
            ...
            <Link
              href={kontakt.karta}
              className="mt-2 inline-flex items-start gap-1.5 text-[16px] leading-snug transition-colors hover:text-lime"
            >
              <span>
                {kontakt.adress}
                <br />
          ...
          <div>
            <p className="text-[13px] text-white/50">Öppettider</p>
          ...
          <div>
            ...
            <Link
              ...
              className="mt-2 inline-block text-[16px] transition-colors hover:text-lime"
            >
              {kontakt.telefon}
            </Link>
            <p className="text-[13px] text-white/50">Mån–Fre 8:30–17:00</p>
          </div>
        </div>
      </div>
    </section>
